...
- **`skills/plain-english`** — правила ясного английского письма. Есть своя машинная проверка (`scripts/prose-check.mjs`), которая ловит пассивный залог, формальные слова, спрятанные глаголы, пустой текст ссылки и длинные предложения.
