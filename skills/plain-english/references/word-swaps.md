...
This is the full version of rule 3, "Use short, everyday words". It comes in two parts, and the split matters for how you use the list.
...
> When you build a machine check for this skill, transcribe only the **strict list** into its rules file. The judgment list stays here as guidance for the model, not as machine rules.
...
| `require` | need | the text carries a formal legal register |
